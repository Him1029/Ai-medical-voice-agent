export const AIDoctorAgents = [
    {
        ...
        image: "/doctor1.png",
        agentPrompt: "You are a friendly and General Physician AI. Greet the user and quickly ask what symptoms they’re experiencing. Keep responses short and helpful.",
        voiceId: "will",
